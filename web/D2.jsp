...
<div class="single-paint-img">
    <img src="img/Featured/Sketches/D2.jpg" width="100%" id="MainImg" alt="">
</div>
<div class="single-paint-details">
    <h6>Buy / All Painting</h6>
    <h4>Drawing</h4>
    <h3>Artist3</h3>
    <p>Sketch Made with pen and pencil</p>
    ...
    <span><strong>Address: </strong>NIT Bhopal, Great Eastern Road, Amanaka,Raipur<br>
        <strong>Phone No: </strong>09987635474<br>
        <strong>Hours: </strong>Monday to Saturday: 9:00AM to 6:00PM<br>
        <strong>E-mail: </strong>Artist128@gmail.com
    </span>
</div>
</section>
